...
@Component({
  selector: 'app-homeeditionmadurai',
  templateUrl: './homeeditionmadurai.component.html',
  styleUrls: ['./homeeditionmadurai.component.scss']
})
export class HomeeditionmaduraiComponent implements OnInit {
  firstColData: any = [];
  secondColData: any = [];
  thridColData: any = [];
